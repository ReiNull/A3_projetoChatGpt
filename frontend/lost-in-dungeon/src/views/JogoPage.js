...
class JogoPage extends React.Component {
    constructor(props) {
        ...
        this.monstrosStore = new MonstrosStore(this.geradorTextoStore, props.monstrosTotais, props.monstrosEtotais, props.checkbox);
            ...
            <Grid alignItems={"center"}>
                <Grid justifyContent="center" alignItems={"center"}>
                    ...
                    <Grid item sx={{marginTop: '10px'}}>
                        <PainelExibeTexto inventarioJogador={this.jogador.getInventario} statusJogador={this.calaboucoStarterStore.jogador} statusMonstro={this.monstrosStore.getMonstro} texto={this.state.logCompleto} />
                    </Grid>
